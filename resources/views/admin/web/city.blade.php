            ...
            <div class="card-header">
              ...
              <div class="modal fade" id="ModalAdd" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                  <form method="POST" action="/Addcity" enctype="multipart/form-data">
                    @csrf
              ...
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><img src="images/{{$city->imageUrl}} " style="width: 50px; height: 50px"></td>
                    ...
                    <td>
                      <div class="row">
                        ...
                        <button class="btn btn-info" data-id="{{$city->id}}" data-name="{{$city->name}}" data-information="{{$city->information }}" data-imagecity="{{asset('images/'.$city->imageUrl)}}" data-toggle="modal" data-target="#ModalEdit" data-whatever="@getbootstrap">Edit</button>
                      </div>
                      <div class="modal fade" id="ModalEdit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                          <form method="POST" action="/Editcity" enctype="multipart/form-data">
                            @csrf
                            @method('PATCH')
                            <div class="modal-content">
                              <div class="modal-header">
...
<script>
  ...
  $('#ModalEdit').on('show.bs.modal', function(event) {
    ...
    var imageUrl = btnEdit.data('imagecity');
