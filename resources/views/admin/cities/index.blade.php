              ...
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><button data-id="{{$city->id}}" type="button" class="btn btn-primary float-right" data-toggle="modal" data-target="#ModalAddType"><i class="fa fa-plus"></i></button></td>
                      <td>
                      <div class="row">
                        ...
                        <button class="btn btn-info" data-id="{{$city->id}}" data-name="{{$city->name}}" data-information="{{$city->information}}" data-imagecity="{{asset($city->imageUrl)}}" data-toggle="modal" data-target="#ModalEdit">Edit</button>
                      </div>
                    </td>
                  </tr>
