...
Route::get('/details/{content?}', [App\Http\Controllers\DetailsController::class, 'index'])->name('detailsIndex');
Route::post('/Adddetails', [App\Http\Controllers\DetailsController::class, 'create'])->name('detailsAdd');
Route::patch('/Editdetails/{id}', [App\Http\Controllers\DetailsController::class, 'update'])->name('detailsEdit');
